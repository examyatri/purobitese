/* ─────────────────────────────────────────────────────────
   Tiffo — Admin Service Worker (sw-admin.js)
   Version : v2.0  |  Updated : 2026-04-23

   Dedicated SW for Admin PWA — installs separately from
   main Tiffo app so admin.html appears as its own app
   on home screen with name "Tiffo Admin".
   ───────────────────────────────────────────────────────── */

const CACHE      = 'tiffo-admin-v2';
const FONT_CACHE = 'tiffo-fonts-v1';

/* Only admin assets */
const PRECACHE = ['./admin.html', './manifest-admin.json'];
